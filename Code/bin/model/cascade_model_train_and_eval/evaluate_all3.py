...
def commit_result(process_data, predict_spo_lists):
    ...
    result_f = open('.\commit_result4.json', 'w', encoding='UTF-8')
    for i, (_, rows) in enumerate(process_data.valid_data.iterrows()):
       result = {}
...
def evaluate(p_process_data, ps_process_data, pso_process_data):#测试完毕        
    ...
    try:
        ...
        print('预测完毕')
        with open('.\out4.json', 'w', encoding='UTF-8') as f:
            out = {}
...
if __name__ == '__main__':
    ...
    p_process_data = process_data(p_train_data_path_list, p_test_data_path, pre_word_embedding_path, \
                                  baike_word_embedding_path, postag_path, p_path, 'F:/wangyi_competition-master/Code/data/test_data_postag4.json')
    ...
    print('F:/wangyi_competition-master/Code/data/test_data_postag4.json')
    batch_size = 1
    out_len = 49
