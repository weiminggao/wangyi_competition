...
def commit_result(process_data, predict_spo_lists):
    ...
    result_f = open('.\commit_result3.json', 'w', encoding='UTF-8')
    for i, (_, rows) in enumerate(process_data.valid_data.iterrows()):
       result = {}
...
if __name__ == '__main__':
    ...
    p_process_data = process_data(p_train_data_path_list, p_test_data_path, pre_word_embedding_path, \
                                  baike_word_embedding_path, postag_path, p_path, 'F:/wangyi_competition-master/Code/data/test_data_postag3.json')
    ...
    print('F:/wangyi_competition-master/Code/data/test_data_postag3.json')
    batch_size = 1
    out_len = 49
